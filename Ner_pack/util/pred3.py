...
def test():
    ...
    if ({'AI': {'10': 'I-tim', '2nd': 'B-org', 'Trump': 'B-per', 'morning': 'B-tim'},'date': '2nd may', 'destination': 'kolkata','location': ['delhi', 'kolkata'],'start': 'delhi','time': '10 pm'}==AI_RB_entity(s)):
      print('    AI_RB_PASSED')
    else:
      print('    AI_RB_FAILED')
